...
class _CumplimientoEjercitacionPageState extends State<CumplimientoEjercitacionPage> {
  ...
  Future<void> _cargarDatos() async {
    try {
      final cumplimientos = await ApiService.fetchCumplimientosEjercitacion(widget.idejercitacion);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            Text(widget.nombreEjercicio, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400)),
          ],
        ),
        ...
        : Column(
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    Text("INSTRUCCIÓN", style: TextStyle(fontSize: 10, color: Colors.indigo, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
                    SizedBox(height: 5),
                  ...
                  builder: (context) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Material(
                          color: cumplido ? Colors.green.withOpacity(0.05) : (esHoy ? Colors.indigo.withOpacity(0.05) : Colors.white),
                          child: InkWell(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: cumplido ? Colors.green : (esHoy ? Colors.indigo : Colors.grey[200]),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        backgroundColor: Colors.indigo,
        label: Text("REGISTRAR EJERCICIO"),
