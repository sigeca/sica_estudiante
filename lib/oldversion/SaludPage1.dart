...
import 'AlimentacionPage.dart'; // <--- IMPORTANTE
import 'EjercitacionPage.dart'; // <--- IMPORTANTE
...
class _SaludPageState extends State<SaludPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: 4, vsync: this); // Reducido a 3 pestañas
    _cargarTodo();
  }
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          await Navigator.push(context,MaterialPageRoute(builder: (context) => CumplimientoPage(detalle: d, nombreMedicamento: item.nombre),
                            ),
                          );
            ...
            children: [
              ...
              TabBar(
                ...
                tabs: [
                  ...
                  Tab(icon: Icon(Icons.fitness_center), text: "Ejercitación"),
                ],
              ),
            ],
          ),
      ...
      body: isLoading 
        ...
        : TabBarView(
            ...
            children: [
              ...
              AlimentacionPage(idpersona: widget.idpersona, cedula: widget.cedula),
              EjercitacionPage(idpersona: widget.idpersona, cedula: widget.cedula)
            ],
          ),
