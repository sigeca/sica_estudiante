...
@override
  ...
  List<Widget> _buildPages() {
    return [
      _buildContenido(),
       widget.idtipogrupoparticipante == '6' ? _buildParticipante() : _buildAsistencia(),
       widget.idtipogrupoparticipante == '6' ? _buildTomarAsistencia() : _buildParticipacion(),
      _buildNota(),
      _buildPago(),
    ];
  }
            ...
            itemBuilder: (context, index) {
              ...
              switch (tipo) {
                case 1: // Puntual
                  ...
                  break;
                case 2: // Atrasado
                  tarjetaColor = Colors.lightGreen;
                  break;
                case 3: // Falta Justificada
                  tarjetaColor = Colors.red;
                  break;
               ...
               elevation: 4.0,
                ...
                title: Row(
                     mainAxisAlignment: MainAxisAlignment.spaceBetween, // Distribute space
                            children: [
                              Text(
                    'ID: ${sesion.idsesionevento} - Sesión No: ${numerosesion}', 
                    style: TextStyle(color: textColor),
                    ),

          if( widget.idtipogrupoparticipante == '6')
 Row(
                    mainAxisSize: MainAxisSize.min, // Ocupa solo el espacio necesario para los hijos
                    children: [
                      ...
                      subtitle: Column(
                        ...
                        children: [
                            Text.rich(
                                TextSpan(
                                    children:[ 
                                      TextSpan(text: 'Fecha dictada: ', style: TextStyle(fontWeight: FontWeight.bold)),
                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(text: 'Tema:', style: TextStyle(fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                            Card(
                              margin: EdgeInsets.only(top: 4.0, bottom: 8.0), // Adjust margin for spacing
                              color: Colors.blueGrey[50], // Example contrasting color
                              elevation: 2.0,
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(text: 'Metodología: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                  TextSpan(text: '${sesion.metodologia}'),
                                ],
                              ),
                            ),
                             Text.rich(
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(text: '${sesion.duracionminutos}'),
                                    ],
                                  ),
                                ),
                              ],
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items:  [
         const BottomNavigationBarItem(icon: Icon(Icons.list), label: 'Syllabus'),
          BottomNavigationBarItem(icon: widget.idtipogrupoparticipante=='6' ? const Icon(Icons.people) :  const Icon(Icons.check_circle_outline) ,
          label: widget.idtipogrupoparticipante == '6' ? 'Participante' : 'Asiste',
              ),
        BottomNavigationBarItem(icon: widget.idtipogrupoparticipante=='6' ? const Icon(Icons.check_circle_outline) :  const Icon(Icons.note_alt_outlined) ,
          label: widget.idtipogrupoparticipante == '6' ? 'Asiste' : 'Participa',
              ),
          ...
          const BottomNavigationBarItem(icon: Icon(Icons.bar_chart), label: 'Participa'),
